		                    ...
		                    <div class="col-lg-12">
		                    	<div class="widget-bg-color-icon card-box">
									...
									<table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>';
										$i=0;
										$rs = mysql_query("SELECT * FROM `jackpotgames` ORDER BY `id` DESC");
										while($row = mysql_fetch_array($rs))
										{
											...
											else
											{
												...
												$ticket=$row['module']*$row['value'];
												echo'
												<tr>
													<td>'.$row['id'].'</td>
													<td><a href="profile.php?action=view&id='.$row['winnerid'].'" target="_BLANK">'.$winner.'</a></td>
													<td>'.$row['value'].' Credits</td>
													<td>'.$row['percent'].'%</td>
													<td>'.$row['itemsnum'].'</td>
													<td>'.$row['module'].'</td>
													<td>'.$ticket.'</td>
