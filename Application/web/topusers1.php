...
<?php
		...
		echo'     					
			<div class="col-md-4 col-lg-4">
				<div class="widget-bg-color-icon card-box">
						...
						<h2>'.$name.'</h2></a>
						<p><font color="green">'.$profit.' Credits</font></p>
		...
		echo'     					
			<div class="col-md-4 col-lg-4">
				<div class="widget-bg-color-icon card-box">
						<a href="profile.php?action=view&id='.$steamid.'" target="_BLANK"><img src="https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/e3/'.$avatar.'" width="100px" alt="user-img" class="img-circle hoverZoomLink">
						<h2>'.$name.'</h2></a>
						<p><font color="green">'.$won.' Credits</font></p>
						<div>Most amount won by a user</div>
				</div>
			</div>
		';
		
	$rs0 = mysql_query("SELECT value,winnerid FROM `jackpotgames` ORDER BY value DESC");						
	...
	$rs0 = mysql_query("SELECT percent,value,winnerid FROM `jackpotgames` WHERE percent!='' ORDER BY `percent` ASC");						
	$row = mysql_fetch_row($rs0);
	$percent=$row[0];
