            ...
            <div class="content-page">
                ...
                <div class="content" style="text-align:center;">
                	<h1>History</h1>
						...
						<?php
						$i=0;
						$rs = mysql_query("SELECT * FROM `jackpotgames` ORDER BY `id` DESC LIMIT 15");
						while($row = mysql_fetch_array($rs))
						{
							...
							$rs3 = mysql_query("SELECT COUNT(cost) AS items FROM `jackpotdeposits` WHERE `gameid`='$rno'");						
							$rf = mysql_fetch_assoc($rs3);
							$amount = $rf["items"];
								
							$lastwinner = $row["winnerid"];
                        ...
                        <div class="widget-bg-color-icon card-box">
								...
								<p><span class="arm"><b>Jackpot:</b> &ensp; <font color="#009700">'.$winnercost.' Credits</font> value</span>, <font color="b3b300">'.$amount.'</font> deposit(s)</p>
								</div><br><br><br><br>';
								echo' </article>  </div>
                    </div>';	
}
